...
add_filter('pre_http_request', function($preempt, $parsed_args, $url) {
    if ($parsed_args['method'] === 'POST' && strpos($url, 'https://getwpo.com/plugin-info/') !== false) {
        $response_array = [
            "version" => 1,
            "code" => "OK",
            "data" => [
                "plugin_info" => [
                    ...
                    "slug" => "wp-optimize-premium",
                    "author" => "getwpo.com",
                    "homepage" => "https://getwpo.com",
                    "sections" => [
                        "description" => "Optimize your WordPress database.",

...
<div class="ocdi">
	...
	<div class="ocdi__content-container">
		...
		$code = (isset($_POST["gusta-purchase-code"]) ? strip_tags($_POST["gusta-purchase-code"]) : get_option('smart_sections_purchase_code'));
	if (isset($_POST["gusta-new-purchase-code"])):
		update_option( 'smart_sections_purchase_code', '' );
		echo '<script>location.reload();</script>';
	endif;
	if (isset($_POST["gusta-verify-purchase-code"])):
		if ($code!=''):
			update_option( 'smart_sections_purchase_code', $code );
			echo '<script>location.reload();</script>';
		endif;
	endif;
	?>

...
HTML;
		...
		public function addGridScripts() {
			if ( $this->isSamePostType() ) {
				wp_enqueue_script( 'wpb_templatera-grid-id-param-js', $this->assetUrl( 'js/templatera-grid-id-param.js' ), array( 'vc-backend-actions-js' ), WPB_VC_REQUIRED_VERSION, true );
			}
		}

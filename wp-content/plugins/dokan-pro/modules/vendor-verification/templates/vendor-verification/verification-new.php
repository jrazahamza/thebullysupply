            ...
            <div class="dokan-panel-body">
                    ...
                    <div class="dokan_v_phone_box">
                        <form method="post" id="dokan-verify-phone-form"  action="" class="dokan-form-horizontal">
                            ...
                            <div class="dokan-form-group">
                                ...
                                <div class="dokan-w5">
                                    <input id="phone" value="<?php echo esc_attr( $phone ); ?>" name="phone" placeholder="<?php esc_attr_e( '+123456..', 'dokan' ); ?>" class="dokan-form-control input-md" type="text"><br>
                ...
                <?php } elseif ( 'verified' === $phone_status ) { ?>
                    ...
                    <div class="dokan-alert dokan-alert-success">
                        <p><?php esc_attr_e( 'Your Verified Phone number is : ', 'dokan' ); echo '<b>' . esc_html(  $phone_no ) . '</b>'; ?></p>
                    </div>
    ...
    <div class="dokan-panel dokan-panel-default">
        ...
        <div class="dokan-panel-body">
            ...
            if ( '' !== $company_v_status ) {
                ...
                switch ( $company_v_status ) {
                    case 'approved':
                        $alert_class = 'dokan-alert-success';
                        $cancel_btn_class = 'dokan-hide';
                        $status = __( 'Approved', 'dokan' );
                        break;
                    case 'rejected':
                        $alert_class = 'dokan-alert-danger';
                        $cancel_btn_class = 'dokan-hide';
                        $status = __( 'Rejected', 'dokan' );
                        break;
                    case 'pending':
                        $alert_class = 'dokan-alert-warning';
                        $status = __( 'Pending', 'dokan' );
                        break;
                }
            } ?>
            ...
            <div class="dokan-alert <?php echo $alert_class; ?>" id="d_v_company_feedback">
                ...
                <?php echo sprintf( __( 'Your company verification request is %s', 'dokan' ), $status ); ?>
            </div>

...
use Merkulove\HugerElementor\Unity\Cache;
use Merkulove\HugerElementor\Unity\Helper;
use Merkulove\HugerElementor\Unity\Plugin;
use Merkulove\HugerElementor\UninstallHelper;
use Merkulove\HugerElementor\Unity\EnvatoItem;
...
final class Uninstall {
    ...
    private function remove_settings() {
        ...
        foreach ( wp_load_alloptions() as $option => $value ) {
            if ( strpos( $option, 'mdp_huger_elementor' ) === 0 ) {
                $settings[] = $option;
            }
        }
    ...
    public function get_uninstall_mode() {
        ...
        if ( isset( $uninstall_settings[ 'mdp_huger_elementor_migration_settings' ] ) && $uninstall_settings[ 'mdp_huger_elementor_migration_settings' ] ) { // Default value.
            $uninstall_settings = [

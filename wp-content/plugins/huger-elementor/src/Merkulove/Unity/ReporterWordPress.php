...
final class ReporterWordPress {
	...
	public function get_title() {
        ...
        return esc_html__( 'WordPress Environment', 'huger-elementor' );
	...
	public function get_fields() {
		...
		return [
			'version'               => esc_html__( 'Version', 'huger-elementor' ),
			'site_url'              => esc_html__( 'Site URL', 'huger-elementor' ),
			'home_url'              => esc_html__( 'Home URL', 'huger-elementor' ),
			'is_multisite'          => esc_html__( 'WP Multisite', 'huger-elementor' ),
			'max_upload_size'       => esc_html__( 'Max Upload Size', 'huger-elementor' ),
			'memory_limit'          => esc_html__( 'Memory limit', 'huger-elementor' ),
			'permalink_structure'   => esc_html__( 'Permalink Structure', 'huger-elementor' ),
			'language'              => esc_html__( 'Language', 'huger-elementor' ),
			'timezone'              => esc_html__( 'Timezone', 'huger-elementor' ),
			'admin_email'           => esc_html__( 'Admin Email', 'huger-elementor' ),
			'debug_mode'            => esc_html__( 'Debug Mode', 'huger-elementor' ),
		];
	...
	public function get_memory_limit() {
		...
		if ( $memory_limit_bytes < $min_recommended_bytes ) {
			$result['recommendation'] = esc_html__( 'We recommend setting memory to at least 64M. For more information, ask your hosting provider.', 'huger-elementor' );
	...
	public function get_is_multisite() {
		...
		return [
			'value' => is_multisite() ? esc_html__( 'Yes', 'huger-elementor' ) : esc_html__( 'No', 'huger-elementor' )
		];
	...
	public function get_permalink_structure() {
		...
		if ( ! $structure ) {
			$structure = esc_html__( 'Plain', 'huger-elementor' );
		}
	...
	public function get_debug_mode() {
		...
		return [
			'value' => WP_DEBUG ? esc_html__( 'Active', 'huger-elementor' ) : esc_html__( 'Inactive', 'huger-elementor' )
		];

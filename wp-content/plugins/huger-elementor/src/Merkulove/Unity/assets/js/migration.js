...
"use strict";
/*!*******************************************************!*\
  !*** ./wp-content/plugins/huger-elementor/js/source/exp.js ***!
  \*******************************************************/
...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        const { ajaxURL, nonce } = mdpHugerElementorUnity;
            ...
            $exportButton.addEventListener('click', (e) => {
                ...
                xhr.onload = () => {
                    ...
                    if (xhr.status === 200) {
                        ...
                        // Download file
                        let fileName = 'huger-elementor-settings.json'
                ...
                xhr.send(`action=export_settings_huger_elementor&nonce=${nonce}`);
        ...
        function readFile( file ) {
            ...
            reader.onload = ( function( theFile ) {
                ...
                return function( e ) {
                    ...
                    xhr.send(`action=import_settings_huger_elementor&nonce=${ nonce }&import=${ encodeURIComponent( JSON.stringify( json ) ) }`);

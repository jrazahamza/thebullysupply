...
( function ( $ ) {
    ...
    $( document ).ready( function () {
        ...
        let mdpHugerElementor = window.mdpHugerElementorUnity;
        ...
        $subscribeBtn.on( 'click', function (e) {
            ...
            if ( $mail.val().length > 0 && window.MerkulovMaterial[mailIndex].valid) {
                ...
                $.ajax({
                    type: "GET",
                    url: `${ mdpHugerElementor.restBase }huger-elementor/v2/subscribe`,
                    crossDomain: true,
        ...
        $checkUpdatesBtn.on( 'click', function ( e ) {
            ...
            let data = {
                action: 'check_updates_huger_elementor',
                nonce: mdpHugerElementor.nonce,
                checkUpdates: true
            };

            /** Do AJAX request. */
            $.post( mdpHugerElementor.ajaxURL, data, function( response ) {

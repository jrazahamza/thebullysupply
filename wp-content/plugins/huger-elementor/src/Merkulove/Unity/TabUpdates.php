...
final class TabUpdates extends Tab {
    ...
    private function __construct() {
        ...
        /** Reset Settings. */
        add_action( 'wp_ajax_check_updates_huger_elementor', [ __CLASS__, 'ajax_check_updates' ] );
	...
	public function add_settings() {
        ...
        add_settings_field( 'check_updates', esc_html__( 'Check for updates:', 'huger-elementor' ), [ $this, 'check_updates' ], $group, $section );

        /** Check SSL */
        add_settings_field( 'check_ssl', esc_html__( 'SSL verification:', 'huger-elementor' ), [ $this, 'check_ssl' ], $group, $section );
    ...
    public function check_updates() {
        ...
        UI::get_instance()->render_button(
            esc_html__( 'Clear cache', 'huger-elementor' ),
            '',
            'autorenew',
            [
                "name" => 'mdp_huger_elementor_' . self::TAB_SLUG . '_settings' . "[check_updates]",
                "id" => "mdp-updates-btn",
    ...
    public function check_ssl() {
        ...
        UI::get_instance()->render_switcher(
            ...
            esc_html__( 'SSL verification', 'huger-elementor' ),
            esc_html__( 'Enable to activate the SSL check when receiving updates', 'huger-elementor' ),
            [
                "name" => 'mdp_huger_elementor_' . self::TAB_SLUG . '_settings' . "[check_ssl]",
            ]

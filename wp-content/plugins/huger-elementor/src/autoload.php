...
final class Autoload {
    ...
    public static function load( $class ) {
        ...
        /** Classes from Huger for Elementor. */
        $file_p = self::get_plugin_class_file( $class );

        /** If Class exists in Huger for Elementor - load it. */
    ...
    private static function get_unity_class_file( $class ) {
        ...
        return $file . self::$DS . str_replace( ['HugerElementor\\', '\\'], ['', self::$DS], $class ) . '.php';

    }

    /**
     * Build file path for classes from Huger for Elementor directory.
     *
     * @param string $class - Called class name.
     *
     * @static
